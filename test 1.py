...
def calculate_clustering_delivery_time(cluster_centers, locations, labels, drone_speed, truck_speed, service_time, max_drones_per_cluster=N_DRONES):
    ...
    # The service time is dependent on the number of clusters rather than the number of delivery locations
    ...
    return total_time, truck_time, total_drone_time, total_service_time
...
def evaluate_performance(n_iterations, drone_speed=40.0, truck_speed=60.0, service_time=5.0):
    ...
    for _ in range(n_iterations):
        ...
        cluster_time, cluster_truck_time, cluster_drone_time, cluster_service_time = calculate_clustering_delivery_time(cluster_centers, locations, labels, drone_speed, truck_speed, service_time)
        if cluster_time:
        ...
        if optimized_weights is not None:
            optimize_time, optimize_truck_time,optimize_drone_time, optimize_service_time = calculate_optimize_weights_delivery_time(optimized_weights, cluster_centers, locations, labels, drone_speed, truck_speed, service_time)
    ...
    save_data_to_csv('Output.csv', Iteration=np.arange(1, n_iterations + 1),Total_delivery_times_tsp=Total_delivery_times_tsp, Total_delivery_times_cluster=Total_delivery_times_cluster, Total_delivery_times_optimize=Total_delivery_times_optimize, Total_travel_times_tsp=Total_travel_times_tsp, Total_travel_times_cluster=Total_travel_times_cluster, Total_travel_times_optimize=Total_travel_times_optimize, Total_truck_times_tsp=Total_truck_times_tsp, Total_truck_times_cluster=Total_truck_times_cluster, Total_truck_times_optimize=Total_truck_times_optimize, Total_drone_times_cluster=Total_drone_times_cluster, Total_drone_times_optimize=Total_drone_times_optimize, Total_service_times_tsp=Total_service_times_tsp, Total_service_times_cluster=Total_service_times_cluster, Total_service_times_optimize=Total_service_times_optimize, Number_of_clusters=Total_number_of_clusters)
    ...
    plot_service_times(n_iterations, Total_service_times_tsp, Total_service_times_cluster, Total_service_times_optimize) 
    """
