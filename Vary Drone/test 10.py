...
def optimize_weights(cluster_centers, locations, labels, drone_speed, truck_speed, service_time):
    ...
    def objective(weights):
        ...
        delivery_time = calculate_optimize_weights_delivery_time(weights, cluster_centers, locations, labels, drone_speed, truck_speed, service_time, N_DRONES)[0]
...
def main():
    ...
    for num_drones in range(2, 17, 2):
